...
local function configTable()
	...
	options.args.logo = ACH:Description('', 1, nil, Engine.Config.Logo, imageCoords, 160, 160, width, hidden)
	...
	Help.args.step5.args.button1 = ACH:Execute(L["Setup OmniCD"], format(L["Re-Run %s setup part of the installation process."], 'OmniCD'), 1, function() if not E:IsAddOnEnabled('OmniCD') then return end Engine:SetupOmniCD() end, nil, nil, nil, nil, nil, E.Retail or not (E:IsAddOnEnabled('OmniCD')))
